...
describe("Client", function () {
  ...
  describe("request", function () {
    describe("when valid", function () {
      ...
      //   const request = nock("https://api.tinify.com").get("/").reply(200, {});
      ...
      describe("with app id", function () {
        ...
        it("should issue request with user agent", function () {
          const request = nock("https://api.tinify.com", {
            reqheaders: {
              "user-agent": tinify.Client.USER_AGENT + " TestApp/0.1",
            },
          })
            .get("/")
            .reply(200, {});
      ...
      describe("with proxy", function () {
        beforeEach(function () {
          this.subject = new tinify.Client(
            "key",
            null,
    ...
    describe("with bad server response repeatedly", function () {
      ...
      //     assert.equal(
      //       error.message,
      //       "Error while parsing response: Unexpected token < in JSON at position 0 (HTTP 543/ParseError)"
      //     );
      //   } else {
      //     assert.equal(
      //       error.message,
      //       "Error while parsing response: Unexpected token < (HTTP 543/ParseError)"
      //     );
      //   }
      // });
